...
public class ClassDescButtonMessage {
	private final int buttonID, x, y, z;

	public ClassDescButtonMessage(FriendlyByteBuf buffer) {
	...
	public ClassDescButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(ClassDescButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(ClassDescButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = ClassDescMenu.guistate;
