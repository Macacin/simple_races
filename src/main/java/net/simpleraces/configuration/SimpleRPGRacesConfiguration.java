...
public class SimpleRPGRacesConfiguration {
	...
	public static final ModConfigSpec.ConfigValue<Boolean> FORCE_PICK;
	public static final ModConfigSpec.ConfigValue<Boolean> JOIN_MESSAGE;
	public static final ModConfigSpec.ConfigValue<Boolean> DESELECT;
	public static final ModConfigSpec.ConfigValue<String> JOIN_MESSAGE_TEXT;
	public static final ModConfigSpec.ConfigValue<Double> ELF_MAX_HEALTH;
	public static final ModConfigSpec.ConfigValue<Boolean> ELF_BOW_SIGHT;
	public static final ModConfigSpec.ConfigValue<Double> ELF_BOW_BONUS_DAMAGE;
	public static final ModConfigSpec.ConfigValue<Boolean> ELF_MEAT_RESTRICT;
	public static final ModConfigSpec.ConfigValue<Double> ELF_FOREST_SPEED_BUFF;
	public static final ModConfigSpec.ConfigValue<Integer> ELF_MAX_FOREST_SPIRITS;
	public static final ModConfigSpec.ConfigValue<Double> ELF_DODGE_CHANCE_PER_SPIRIT;
	public static final ModConfigSpec.ConfigValue<Integer> ELF_SPIRIT_COOLDOWN_SECONDS;
	public static final ModConfigSpec.ConfigValue<Double> ELF_FOREST_COOLDOWN_MULTIPLIER;
	public static final ModConfigSpec.ConfigValue<Boolean> DWARF_HASTE;
	public static final ModConfigSpec.ConfigValue<Double> DWARF_MAX_HEALTH;
	public static final ModConfigSpec.ConfigValue<Double> DWARF_RES_LEVEL;
	public static final ModConfigSpec.ConfigValue<Boolean> DWARF_SUBZERO_EFFECTS;
	public static final ModConfigSpec.ConfigValue<Boolean> DWARF_BOW_RESTRICT;
	public static final ModConfigSpec.ConfigValue<Double> MERFOLK_SWIM_SPEED;
	public static final ModConfigSpec.ConfigValue<Boolean> MERFOLK_CONDUIT_EFFECT;
	public static final ModConfigSpec.ConfigValue<Double> MERFOLK_DAMAGE_PENALTY_SURFACE;
	public static final ModConfigSpec.ConfigValue<Double> MERFOLK_ATTACK_DAMAGE_WATER;
	public static final ModConfigSpec.ConfigValue<Double> MERFOLK_SURFACE_HEALTH;
	public static final ModConfigSpec.ConfigValue<Double> MERFOLK_SURFACE_SPEED_PENALTY;
	public static final ModConfigSpec.ConfigValue<Boolean> DRAK_FIRE;
	public static final ModConfigSpec.ConfigValue<Boolean> DRAK_FIRE_RES;
	public static final ModConfigSpec.ConfigValue<Boolean> DRAKONID_ARMOR_MELT;
	public static final ModConfigSpec.ConfigValue<Boolean> DRAKONID_WATER_HURT;
	public static final ModConfigSpec.ConfigValue<Integer> DRAKONID_HEAT_PER_ATTACK;
	public static final ModConfigSpec.ConfigValue<Integer> DRAKONID_MAX_HEAT;
	public static final ModConfigSpec.ConfigValue<Integer> DRAKONID_OVERHEAT_TIME;
	public static final ModConfigSpec.ConfigValue<Double> DRAKONID_FALL_MULTIPLY;
	public static final ModConfigSpec.ConfigValue<Integer> DRAKONID_OVERHEAT_FIRE_TIME;
	public static final ModConfigSpec.ConfigValue<Double> FAIRY_FALL_MULTIPLY;
	public static final ModConfigSpec.ConfigValue<Double> FAIRY_FLY_SPEED_MULTIPLY;
	public static final ModConfigSpec.ConfigValue<Double> FAIRY_MAX_HEALTH;
	public static final ModConfigSpec.ConfigValue<Boolean> ELF_EARS;
	public static final ModConfigSpec.ConfigValue<Boolean> ORC_TUSKS;
	public static final ModConfigSpec.ConfigValue<Boolean> MERFOLK_FORM;
	public static final ModConfigSpec.ConfigValue<Boolean> DWARF_RESIZE;
	public static final ModConfigSpec.ConfigValue<Boolean> ELF_RESIZE;
	public static final ModConfigSpec.ConfigValue<Boolean> ORC_RESIZE;
	public static final ModConfigSpec.ConfigValue<Double> ARACHA_MAX_HEALTH;
	public static final ModConfigSpec.ConfigValue<Double> HALFDEAD_MAX_HEALTH;
	public static final ModConfigSpec.ConfigValue<Double> WEREWOLF_BEAST_DAMAGE_BONUS;
	public static final ModConfigSpec.ConfigValue<Double> WEREWOLF_HUMAN_DAMAGE_PENALTY;
	public static final ModConfigSpec.ConfigValue<Double> WEREWOLF_BEAST_SPEED_BONUS;
	public static final ModConfigSpec.ConfigValue<Double> WEREWOLF_HUMAN_SPEED_PENALTY;
	public static final ModConfigSpec.ConfigValue<Double> WEREWOLF_BEAST_HEALTH_BONUS;
	public static final ModConfigSpec.ConfigValue<Double> WEREWOLF_HUMAN_HEALTH_PENALTY;
	public static final ModConfigSpec.ConfigValue<Integer> WEREWOLF_BEAST_DURATION;
	public static final ModConfigSpec.ConfigValue<Integer> WEREWOLF_BLEEDING_DURATION;
	public static final ModConfigSpec.ConfigValue<Double> SERPENTIN_MAX_HEALTH;
	public static final ModConfigSpec.ConfigValue<Double> ORC_DAMAGE_PENALTY;
	public static final ModConfigSpec.ConfigValue<Double> ORC_MAGIC_DAMAGE_PENALTY;
	public static final ModConfigSpec.ConfigValue<Double> ORC_INCOMING_MAGIC_DAMAGE_PENALTY;
	public static final ModConfigSpec.ConfigValue<Double> ORC_EXHAUSTION_MULTIPLIER;
	public static final ModConfigSpec.ConfigValue<Double> ORC_RAGE;
	public static final ModConfigSpec.ConfigValue<Integer> ORC_FERVOR_DEBUFF_DURATION;
	public static final ModConfigSpec.ConfigValue<Integer> ORC_FERVOR_SLOWDOWN_LEVEL;
	public static final ModConfigSpec.ConfigValue<Double> ORC_FERVOR_INCOMING_DAMAGE_MULTIPLIER;
	public static final ModConfigSpec.ConfigValue<Double> MERFOLK_WATER_HEALTH_BOOST;
	public static final ModConfigSpec.ConfigValue<Integer> MERFOLK_DIG_SPEED_WATER;
	public static final ModConfigSpec.ConfigValue<Double> SERPENTIN_DAMAGE_BONUS_WITH_DEBUFF;
	public static final ModConfigSpec.ConfigValue<Double> SERPENTIN_DAMAGE_PENALTY_WITHOUT_DEBUFF;
	public static final ModConfigSpec.ConfigValue<Double> SERPENTIN_POTION_DURATION_MULTIPLIER;
	public static final ModConfigSpec.ConfigValue<Integer> SERPENTIN_STRENGTH_AMPLIFIER_BONUS;
	public static final ModConfigSpec.ConfigValue<Integer> SERPENTIN_SPEED_AMPLIFIER_BONUS;
	public static final ModConfigSpec.ConfigValue<Integer> SERPENTIN_JUMP_AMPLIFIER_BONUS;

	public static final ModConfigSpec.ConfigValue<Integer> ARACHA_WATER_SLOWDOWN_DURATION;
	public static final ModConfigSpec.ConfigValue<Integer> ARACHA_WATER_SLOWDOWN_AMPLIFIER;
	public static final ModConfigSpec.ConfigValue<Integer> ARACHA_BITE_COUNT_THRESHOLD;
	public static final ModConfigSpec.ConfigValue<Integer> ARACHA_POISON_DURATION;
	public static final ModConfigSpec.ConfigValue<Integer> ARACHA_POISON_AMPLIFIER;
	public static final ModConfigSpec.ConfigValue<Double> ARACHA_ATTACK_SPEED_BONUS;
	public static final ModConfigSpec.ConfigValue<Double> ARACHA_FIRE_DAMAGE_MULTIPLIER;
	public static final ModConfigSpec.DoubleValue ARACHA_WEIGHT_MULTIPLIER;

	public static final ModConfigSpec.ConfigValue<Double> HALFDEAD_HEAL_MULTIPLIER;
	public static final ModConfigSpec.ConfigValue<Double> HALFDEAD_AURA_DAMAGE;
	public static final ModConfigSpec.ConfigValue<Integer> HALFDEAD_DEATH_MARK_DURATION;
	public static final ModConfigSpec.ConfigValue<Double> HALFDEAD_DAMAGE_BONUS_VS_UNDEAD;
	public static final ModConfigSpec.ConfigValue<Double> HALFDEAD_DAMAGE_REDUCTION_FROM_MARK;
	public static final ModConfigSpec.ConfigValue<Double> HALFDEAD_DAMAGE_INCREASE_TO_MARKED;

	public static final ModConfigSpec.ConfigValue<Double> HALFDEAD_DEATH_MARK_RADIUS;

	public static final ModConfigSpec.ConfigValue<Integer> FAIRY_MAX_FLYING_TIME;

	public static final ModConfigSpec.ConfigValue<Integer> ELF_CARRY_CAPACITY;
	public static final ModConfigSpec.ConfigValue<Integer> ORC_CARRY_CAPACITY;
	public static final ModConfigSpec.ConfigValue<Integer> DWARF_CARRY_CAPACITY;
	public static final ModConfigSpec.ConfigValue<Integer> MERFOLK_CARRY_CAPACITY;
	public static final ModConfigSpec.ConfigValue<Integer> DRAKONID_CARRY_CAPACITY;
	public static final ModConfigSpec.ConfigValue<Integer> FAIRY_CARRY_CAPACITY;
	public static final ModConfigSpec.ConfigValue<Integer> WEREWOLF_CARRY_CAPACITY;
	public static final ModConfigSpec.ConfigValue<Integer> SERPENTIN_CARRY_CAPACITY;
	public static final ModConfigSpec.ConfigValue<Integer> ARACHA_CARRY_CAPACITY;
	public static final ModConfigSpec.ConfigValue<Integer> HALFDEAD_CARRY_CAPACITY;
	...
	static {
		...
		ELF_CARRY_CAPACITY = BUILDER.comment("Base carry capacity for Elf race").defineInRange("elf_carry_capacity", 18, 0, 1000);
		BUILDER.pop();
		...
		ORC_CARRY_CAPACITY = BUILDER.comment("Base carry capacity for Orc race").defineInRange("orc_carry_capacity", 22, 0, 1000);
		BUILDER.pop();
		...
		DWARF_CARRY_CAPACITY = BUILDER.comment("Base carry capacity for Dwarf race").defineInRange("dwarf_carry_capacity", 15, 0, 1000);
		BUILDER.pop();
		...
		MERFOLK_CARRY_CAPACITY = BUILDER.comment("Base carry capacity for Merfolk race").defineInRange("merfolk_carry_capacity", 20, 0, 1000);
		BUILDER.pop();
		...
		DRAKONID_FALL_MULTIPLY = BUILDER.comment("Drakonid fall damage multiplier").define("drakonid_fall_multiply", 0.80D);
		...
		DRAKONID_CARRY_CAPACITY = BUILDER.comment("Base carry capacity for Drakonid race").defineInRange("drakonid_carry_capacity", 19, 0, 1000);
		BUILDER.pop();
		BUILDER.push("Fairy Class Attributes");
		FAIRY_FALL_MULTIPLY = BUILDER.comment("Fairy fall damage multiplier").define("fairy_fall_multiply", 0.75D);
		FAIRY_FLY_SPEED_MULTIPLY = BUILDER.comment("Fairy fly speed multiplier").define("fairy_fly_speed_multiply", 1.0D);
		...
		FAIRY_CARRY_CAPACITY = BUILDER.comment("Base carry capacity for Fairy race").defineInRange("fairy_carry_capacity", 13, 0, 1000);
		BUILDER.pop();
		...
		WEREWOLF_BLEEDING_DURATION = BUILDER.comment("Bleeding duration of werewolf, defined in ticks").defineInRange("werewolf_bleeding_duration", 200, 100, 1200);
		WEREWOLF_CARRY_CAPACITY = BUILDER.comment("Base carry capacity for Werewolf race").defineInRange("werewolf_carry_capacity", 24, 0, 1000);
		BUILDER.pop();
		...
		SERPENTIN_CARRY_CAPACITY = BUILDER.comment("Base carry capacity for Serpentin race").defineInRange("serpentin_carry_capacity", 18, 0, 1000);
		BUILDER.pop();
		...
		ARACHA_CARRY_CAPACITY = BUILDER.comment("Base carry capacity for Aracha race").defineInRange("aracha_carry_capacity", 17, 0, 1000);
		...
		HALFDEAD_CARRY_CAPACITY = BUILDER.comment("Base carry capacity for Halfdead race").defineInRange("halfdead_carry_capacity", 23, 0, 1000);
		BUILDER.pop();
