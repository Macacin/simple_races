...
public class Start2Menu extends AbstractRaceSelectMenu implements Supplier<Map<Integer, Slot>> {
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof Start2Menu) {
